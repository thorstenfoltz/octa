...
impl OctaApp {
    pub(crate) fn new(
        ...
        Self {
            ...
            sql_snippets_window_open: false,
            sql_snippets_window_size: octa::ui::settings::DialogSize::default(),
            chat_prompts: super::chat_prompts::load(),
            chat_prompt_save: None,
            settings,
            resolved_icon,
            ...
            pending_number_warning: None,
            pending_number_pickers: std::collections::VecDeque::new(),
            pending_file_repair: None,
            pending_round_save: None,
            pending_xlsx_style_save: None,
            xlsx_style_remember: false,
