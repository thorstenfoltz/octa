    ...
    egui::Window::new(octa::i18n::t("dialog.tc_title"))
        ...
        .show(ctx, |ui| {
                ...
                TimeCalcKind::UnixConvert => {
                    ui.horizontal(|ui| {
                        ...
                        egui::ComboBox::from_id_salt("tc_unix_dir")
                            ...
                            .show_ui(ui, |ui| {
                                for dir in [UnixDirection::ToDateTime, UnixDirection::FromDateTime]
                                {
                                    ui.selectable_value(
                    ...
                    let col_label = match state.unix_direction {
                        UnixDirection::ToDateTime => octa::i18n::t("dialog.tc_number_column"),
                        UnixDirection::FromDateTime => octa::i18n::t("dialog.tc_date_column"),
                    };
            ...
            ui.horizontal(|ui| {
                ...
                ui.add(egui::TextEdit::singleline(&mut state.insert_at_text).desired_width(48.0));
