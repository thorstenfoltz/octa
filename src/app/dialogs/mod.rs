...
pub(crate) mod cloud_workspace_picker;
...
pub(crate) mod db_compare;
pub(crate) mod db_copy;
pub(crate) mod db_write_back;
pub(crate) mod delete_columns;
pub(crate) mod distribution_compare;
pub(crate) mod documentation;
pub(crate) mod drift;
pub(crate) mod file_changed;
...
pub(crate) mod new_table;
pub(crate) mod number_ambiguity;
...
impl OctaApp {
    ...
    pub(crate) fn render_dialogs(&mut self, ctx: &egui::Context) {
        ...
        number_ambiguity::render_number_ambiguity_dialog(self, ctx);
        ...
        rel_map::render_rel_map_dialog(self, ctx);
        ...
        cloud_workspace_picker::render_cloud_workspace_picker(self, ctx);
        update_dialog::render_update_dialog(self, ctx);
        release_notes::render_release_notes_dialog(self, ctx);
        ...
        timeseries::render_timeseries_dialog(self, ctx);
        batch_convert::render_batch_convert_dialog(self, ctx);
        workbook::render_workbook_dialog(self, ctx);
        open_url::render_open_url_dialog(self, ctx);
        schema_drift::render_schema_drift_dialog(self, ctx);
        report::render_report_dialog(self, ctx);
        fuzzy_join::render_fuzzy_join_dialog(self, ctx);
        ...
        distribution_compare::render_dist_compare_dialog(self, ctx);
        referential::render_referential_dialog(self, ctx);
        units::render_units_dialog(self, ctx);
        ...
        join_keys::render_join_keys_dialog(self, ctx);
        join_diag::render_join_diag_dialog(self, ctx);
        harmonise::render_harmonise_dialog(self, ctx);
