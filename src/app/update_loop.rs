...
impl OctaApp {
    ...
    fn render_crash_offer(&mut self, ctx: &egui::Context) {
        ...
        let mut close = false;
        let dialog_id = egui::Id::new("octa_crash_offer_dialog");
        ...
        let window = egui::Window::new("octa_crash_offer")
            .id(dialog_id)
            .title_bar(false)
            .collapsible(false);
        ...
        let inner = window.show(ctx, |ui| {
            egui::Panel::top("crash_offer_header")
                .frame(egui::Frame::default().inner_margin(egui::Margin::symmetric(0, 6)))
                .show(ui, |ui| {
                    ui.horizontal(|ui| {
                        ui.label(
                            egui::RichText::new(octa::i18n::t("diagnostics.crash_title"))
                                .strong()
                                .size(16.0),
                        );
