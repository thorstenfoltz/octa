...
pub fn render_write_options(
    ...
    egui::CollapsingHeader::new(crate::i18n::t("wo.title"))
        ...
        .show(ui, |ui| {
            ui.label(RichText::new(crate::i18n::t("wo.parquet")).strong());
            egui::Grid::new("write_options_parquet")
                ...
                .show(ui, |ui| {
                    ...
                    if ui
                        ...
                        .changed()
                    {
                        // Empty (or unparseable) means "leave it to the writer",
                        // which is what `None` says downstream.
            ...
            ui.add_space(6.0);
            ui.label(RichText::new(crate::i18n::t("wo.csv")).strong());
